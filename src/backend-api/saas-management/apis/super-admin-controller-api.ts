...
export const SuperAdminControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        approveOrganization: async (orgMrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/super-admin/org/mrn/{orgMrn}/approve`
         ...
         * @throws {RequiredError}
         */
        getPendingOrganizations: async (page?: number, size?: number, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/super-admin/pending-orgs`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const SuperAdminControllerApiFp = function(configuration?: Configuration) {
    return {
        ...
        async approveOrganization(orgMrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Organization>>> {
            const localVarAxiosArgs = await SuperAdminControllerApiAxiosParamCreator(configuration).approveOrganization(orgMrn, options);
         ...
         * @throws {RequiredError}
         */
        async createOrganization(body: Organization, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Organization>>> {
         ...
         * @throws {RequiredError}
         */
        async getPendingOrganizations(page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PageOrganization>>> {
            const localVarAxiosArgs = await SuperAdminControllerApiAxiosParamCreator(configuration).getPendingOrganizations(page, size, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SuperAdminControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async approveOrganization(orgMrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Organization>> {
            return SuperAdminControllerApiFp(configuration).approveOrganization(orgMrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {InvoiceDto} body 
         ...
         * @throws {RequiredError}
         */
        async createOrganization(body: Organization, options?: AxiosRequestConfig): Promise<AxiosResponse<Organization>> {
         ...
         * @throws {RequiredError}
         */
        async getPendingOrganizations(page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<AxiosResponse<PageOrganization>> {
            return SuperAdminControllerApiFp(configuration).getPendingOrganizations(page, size, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} serviceId 
...
export class SuperAdminControllerApi extends BaseAPI {
    ...
    public async approveOrganization(orgMrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Organization>> {
        return SuperAdminControllerApiFp(this.configuration).approveOrganization(orgMrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {InvoiceDto} body 
     ...
     * @memberof SuperAdminControllerApi
     */
    public async createOrganization(body: Organization, options?: AxiosRequestConfig) : Promise<AxiosResponse<Organization>> {
     ...
     * @memberof SuperAdminControllerApi
     */
    public async getPendingOrganizations(page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig) : Promise<AxiosResponse<PageOrganization>> {
        return SuperAdminControllerApiFp(this.configuration).getPendingOrganizations(page, size, sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {number} serviceId 
