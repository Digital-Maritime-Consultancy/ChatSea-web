...
import { OrganizationServiceUsage } from '../models';
...
export const OrganizationManagementControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createOrganizationSubscription1: async (body: OrganizationSubscriptionDto, orgMrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling createOrganizationSubscription1.');
            }
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling createOrganizationSubscription1.');
            }
            const localVarPath = `/api/org-management/{orgMrn}/subscription`
         ...
         * @throws {RequiredError}
         */
        deleteOrganizationSubscription1: async (orgMrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling deleteOrganizationSubscription1.');
            }
            const localVarPath = `/api/org-management/{orgMrn}/subscription`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        getAllOrganizationServiceUsages: async (orgMrn: string, startDate?: string, endDate?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getAllOrganizationServiceUsages.');
            }
            const localVarPath = `/api/org-management/{orgMrn}/org-service-usages`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getOrganizationServiceUsage: async (orgMrn: string, serviceId: number, startDate?: string, endDate?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getOrganizationServiceUsage.');
            }
            // verify required parameter 'serviceId' is not null or undefined
            if (serviceId === null || serviceId === undefined) {
                throw new RequiredError('serviceId','Required parameter serviceId was null or undefined when calling getOrganizationServiceUsage.');
            }
            const localVarPath = `/api/org-management/{orgMrn}/org-service-usage/{serviceId}`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)))
         ...
         * @throws {RequiredError}
         */
        getOrganizationSubscription1: async (orgMrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getOrganizationSubscription1.');
            }
            const localVarPath = `/api/org-management/{orgMrn}/subscription`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
         ...
         * @throws {RequiredError}
         */
        getSubscriptionPlans2: async (orgMrn: string, page?: number, size?: number, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getSubscriptionPlans2.');
            }
         ...
         * @throws {RequiredError}
         */
        updateOrganizationSubscription1: async (body: OrganizationSubscriptionDto, orgMrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling updateOrganizationSubscription1.');
            }
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling updateOrganizationSubscription1.');
            }
            const localVarPath = `/api/org-management/{orgMrn}/subscription`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const OrganizationManagementControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createOrganizationSubscription1(body: OrganizationSubscriptionDto, orgMrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<OrganizationSubscription>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).createOrganizationSubscription1(body, orgMrn, options);
         ...
         * @throws {RequiredError}
         */
        async deleteOrganizationSubscription1(orgMrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).deleteOrganizationSubscription1(orgMrn, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getAllOrganizationServiceUsages(orgMrn: string, startDate?: string, endDate?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<OrganizationServiceUsage>>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).getAllOrganizationServiceUsages(orgMrn, startDate, endDate, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getOrganizationServiceUsage(orgMrn: string, serviceId: number, startDate?: string, endDate?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<OrganizationServiceUsage>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).getOrganizationServiceUsage(orgMrn, serviceId, startDate, endDate, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getOrganizationSubscription1(orgMrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<OrganizationSubscription>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).getOrganizationSubscription1(orgMrn, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getSubscriptionPlans2(orgMrn: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PageSubscriptionPlan>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).getSubscriptionPlans2(orgMrn, page, size, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateOrganizationSubscription1(body: OrganizationSubscriptionDto, orgMrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<OrganizationSubscription>>> {
            const localVarAxiosArgs = await OrganizationManagementControllerApiAxiosParamCreator(configuration).updateOrganizationSubscription1(body, orgMrn, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrganizationManagementControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createOrganizationSubscription1(body: OrganizationSubscriptionDto, orgMrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<OrganizationSubscription>> {
            return OrganizationManagementControllerApiFp(configuration).createOrganizationSubscription1(body, orgMrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {PaymentDto} body 
         ...
         * @throws {RequiredError}
         */
        async deleteOrganizationSubscription1(orgMrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return OrganizationManagementControllerApiFp(configuration).deleteOrganizationSubscription1(orgMrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getAllOrganizationServiceUsages(orgMrn: string, startDate?: string, endDate?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<OrganizationServiceUsage>>> {
            return OrganizationManagementControllerApiFp(configuration).getAllOrganizationServiceUsages(orgMrn, startDate, endDate, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getOrganizationServiceUsage(orgMrn: string, serviceId: number, startDate?: string, endDate?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<OrganizationServiceUsage>> {
            return OrganizationManagementControllerApiFp(configuration).getOrganizationServiceUsage(orgMrn, serviceId, startDate, endDate, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getOrganizationSubscription1(orgMrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<OrganizationSubscription>> {
            return OrganizationManagementControllerApiFp(configuration).getOrganizationSubscription1(orgMrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getSubscriptionPlans2(orgMrn: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<AxiosResponse<PageSubscriptionPlan>> {
            return OrganizationManagementControllerApiFp(configuration).getSubscriptionPlans2(orgMrn, page, size, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {OrganizationSubscriptionDto} body 
         ...
         * @throws {RequiredError}
         */
        async updateOrganizationSubscription1(body: OrganizationSubscriptionDto, orgMrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<OrganizationSubscription>> {
            return OrganizationManagementControllerApiFp(configuration).updateOrganizationSubscription1(body, orgMrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {PaymentDto} body 
...
export class OrganizationManagementControllerApi extends BaseAPI {
     ...
     */
    public async createOrganizationSubscription1(body: OrganizationSubscriptionDto, orgMrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<OrganizationSubscription>> {
        return OrganizationManagementControllerApiFp(this.configuration).createOrganizationSubscription1(body, orgMrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {PaymentDto} body 
     ...
     * @memberof OrganizationManagementControllerApi
     */
    public async deleteOrganizationSubscription1(orgMrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return OrganizationManagementControllerApiFp(this.configuration).deleteOrganizationSubscription1(orgMrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof OrganizationManagementControllerApi
     */
    public async getAllOrganizationServiceUsages(orgMrn: string, startDate?: string, endDate?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<OrganizationServiceUsage>>> {
        return OrganizationManagementControllerApiFp(this.configuration).getAllOrganizationServiceUsages(orgMrn, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof OrganizationManagementControllerApi
     */
    public async getOrganizationServiceUsage(orgMrn: string, serviceId: number, startDate?: string, endDate?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<OrganizationServiceUsage>> {
        return OrganizationManagementControllerApiFp(this.configuration).getOrganizationServiceUsage(orgMrn, serviceId, startDate, endDate, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof OrganizationManagementControllerApi
     */
    public async getOrganizationSubscription1(orgMrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<OrganizationSubscription>> {
        return OrganizationManagementControllerApiFp(this.configuration).getOrganizationSubscription1(orgMrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof OrganizationManagementControllerApi
     */
    public async getSubscriptionPlans2(orgMrn: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig) : Promise<AxiosResponse<PageSubscriptionPlan>> {
        return OrganizationManagementControllerApiFp(this.configuration).getSubscriptionPlans2(orgMrn, page, size, sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {OrganizationSubscriptionDto} body 
     ...
     * @memberof OrganizationManagementControllerApi
     */
    public async updateOrganizationSubscription1(body: OrganizationSubscriptionDto, orgMrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<OrganizationSubscription>> {
        return OrganizationManagementControllerApiFp(this.configuration).updateOrganizationSubscription1(body, orgMrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {PaymentDto} body 
