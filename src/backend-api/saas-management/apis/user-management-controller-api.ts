...
export const UserManagementControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createUser: async (body: UserDto, orgMrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
         ...
         * @throws {RequiredError}
         */
        deleteUser: async (orgMrn: string, mrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
            ...
            // verify required parameter 'mrn' is not null or undefined
            if (mrn === null || mrn === undefined) {
                throw new RequiredError('mrn','Required parameter mrn was null or undefined when calling deleteUser.');
            }
         ...
         * @throws {RequiredError}
         */
        editUser: async (body: UserDto, orgMrn: string, mrn: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling editUser.');
            }
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling editUser.');
            }
            // verify required parameter 'mrn' is not null or undefined
            if (mrn === null || mrn === undefined) {
                throw new RequiredError('mrn','Required parameter mrn was null or undefined when calling editUser.');
            }
            const localVarPath = `/api/user-management/org/{orgMrn}/mrn/{mrn}`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)))
                .replace(`{${"mrn"}}`, encodeURIComponent(String(mrn)));
         ...
         * @throws {RequiredError}
         */
        getAllUserServiceSubscriptions: async (orgMrn: string, page?: number, size?: number, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getAllUserServiceSubscriptions.');
            }
            const localVarPath = `/api/user-management/org/{orgMrn}/service-subscriptions`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getAllUserServiceUsages: async (orgMrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getAllUserServiceUsages.');
            }
            const localVarPath = `/api/user-management/org/{orgMrn}/all-user-service-usages`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getUserServiceUsageByUser: async (orgMrn: string, mrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgMrn' is not null or undefined
            if (orgMrn === null || orgMrn === undefined) {
                throw new RequiredError('orgMrn','Required parameter orgMrn was null or undefined when calling getUserServiceUsageByUser.');
            }
            // verify required parameter 'mrn' is not null or undefined
            if (mrn === null || mrn === undefined) {
                throw new RequiredError('mrn','Required parameter mrn was null or undefined when calling getUserServiceUsageByUser.');
            }
            const localVarPath = `/api/user-management/org/{orgMrn}/mrn/{mrn}/user-service-usages`
                .replace(`{${"orgMrn"}}`, encodeURIComponent(String(orgMrn)))
                .replace(`{${"mrn"}}`, encodeURIComponent(String(mrn)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
...
export const UserManagementControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createUser(body: UserDto, orgMrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<User>>> {
            const localVarAxiosArgs = await UserManagementControllerApiAxiosParamCreator(configuration).createUser(body, orgMrn, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async deleteUser(orgMrn: string, mrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await UserManagementControllerApiAxiosParamCreator(configuration).deleteUser(orgMrn, mrn, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async editUser(body: UserDto, orgMrn: string, mrn: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>> {
            const localVarAxiosArgs = await UserManagementControllerApiAxiosParamCreator(configuration).editUser(body, orgMrn, mrn, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getAllUserServiceSubscriptions(orgMrn: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PageUserServiceSubscription>>> {
            const localVarAxiosArgs = await UserManagementControllerApiAxiosParamCreator(configuration).getAllUserServiceSubscriptions(orgMrn, page, size, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getAllUserServiceUsages(orgMrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PageUserServiceUsage>>> {
            const localVarAxiosArgs = await UserManagementControllerApiAxiosParamCreator(configuration).getAllUserServiceUsages(orgMrn, startDate, endDate, page, size, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getUserServiceUsageByUser(orgMrn: string, mrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PageUserServiceUsage>>> {
            const localVarAxiosArgs = await UserManagementControllerApiAxiosParamCreator(configuration).getUserServiceUsageByUser(orgMrn, mrn, startDate, endDate, page, size, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UserManagementControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createUser(body: UserDto, orgMrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<User>> {
            return UserManagementControllerApiFp(configuration).createUser(body, orgMrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {UserServiceSubscriptionDto} body 
         ...
         * @throws {RequiredError}
         */
        async deleteUser(orgMrn: string, mrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return UserManagementControllerApiFp(configuration).deleteUser(orgMrn, mrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async editUser(body: UserDto, orgMrn: string, mrn: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>> {
            return UserManagementControllerApiFp(configuration).editUser(body, orgMrn, mrn, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getAllUserServiceSubscriptions(orgMrn: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<AxiosResponse<PageUserServiceSubscription>> {
            return UserManagementControllerApiFp(configuration).getAllUserServiceSubscriptions(orgMrn, page, size, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getAllUserServiceUsages(orgMrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<AxiosResponse<PageUserServiceUsage>> {
            return UserManagementControllerApiFp(configuration).getAllUserServiceUsages(orgMrn, startDate, endDate, page, size, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a page of all users in an organization
         * @param {string} orgMrn 
         ...
         * @throws {RequiredError}
         */
        async getUserServiceUsageByUser(orgMrn: string, mrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<AxiosResponse<PageUserServiceUsage>> {
            return UserManagementControllerApiFp(configuration).getUserServiceUsageByUser(orgMrn, mrn, startDate, endDate, page, size, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {UserServiceSubscriptionDto} body 
...
export class UserManagementControllerApi extends BaseAPI {
     ...
     * @memberof UserManagementControllerApi
     */
    public async createUser(body: UserDto, orgMrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<User>> {
        return UserManagementControllerApiFp(this.configuration).createUser(body, orgMrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {UserServiceSubscriptionDto} body 
     ...
     * @memberof UserManagementControllerApi
     */
    public async deleteUser(orgMrn: string, mrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return UserManagementControllerApiFp(this.configuration).deleteUser(orgMrn, mrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof UserManagementControllerApi
     */
    public async editUser(body: UserDto, orgMrn: string, mrn: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<void>> {
        return UserManagementControllerApiFp(this.configuration).editUser(body, orgMrn, mrn, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof UserManagementControllerApi
     */
    public async getAllUserServiceSubscriptions(orgMrn: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig) : Promise<AxiosResponse<PageUserServiceSubscription>> {
        return UserManagementControllerApiFp(this.configuration).getAllUserServiceSubscriptions(orgMrn, page, size, sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {string} orgMrn 
     ...
     * @memberof UserManagementControllerApi
     */
    public async getAllUserServiceUsages(orgMrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig) : Promise<AxiosResponse<PageUserServiceUsage>> {
        return UserManagementControllerApiFp(this.configuration).getAllUserServiceUsages(orgMrn, startDate, endDate, page, size, sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Get a page of all users in an organization
     * @param {string} orgMrn 
     ...
     * @memberof UserManagementControllerApi
     */
    public async getUserServiceUsageByUser(orgMrn: string, mrn: string, startDate?: string, endDate?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig) : Promise<AxiosResponse<PageUserServiceUsage>> {
        return UserManagementControllerApiFp(this.configuration).getUserServiceUsageByUser(orgMrn, mrn, startDate, endDate, page, size, sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {UserServiceSubscriptionDto} body 
